...
/home/pdybczak/rs_work/rnd/tft/original_implementation_new_data/repo/tft/outputs/saved_models/mpwik/fixed/TemporalFusionTransformer.ckpt  
loss: 0.0561 - val_loss: 0.1070
...
```{python}
evaluator.calculate_sklearn_metrics(t='t+5')
```
...
pd.DataFrame({k: pd.Series(m[k], index=['dummy_static']) for k in m})
```
